...
<head>
    ...
    <link rel="stylesheet" href="css/afternoonteaRe.css">
    <title>アフタヌーンティー予約フォーム</title>
</head>
<body>
    ...
    <section class="sectionContainar">
        <form action="afternoonteaReserveconf.php" method="POST" class="formContainar" id="JsForm">
            <div>
